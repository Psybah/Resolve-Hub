  ...
  return `
    <div class="process-card">
      ...
      <div class="process-card-body">
        ...
        <div class="process-time-eye" style="display: flex; align-items: center; justify-content: space-between;">
          <div class="process-time">Time: ${process.time}</div>
          <span class="process-eye-icon" data-processid="${process.id}" style="cursor:pointer;display:inline-flex;align-items:center;justify-content:center;margin-left:1em;" onclick="showProcessTimelineModal('${process.id}')">
